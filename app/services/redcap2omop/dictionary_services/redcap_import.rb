    ...
    def run
      ...
      ActiveRecord::Base.transaction do
        ...
        data_dictionary_variables.each do |data_dictionary_variable|
          ...
          if redcap_project.redcap_variable_field_type_changed_in_redcap_data_dictionary?(data_dictionary_variable['field_name'], data_dictionary_variable['field_type'], data_dictionary_variable['text_validation_type_or_show_slider_number'])
            new_data_dictionary = true
          ...
          if redcap_project.redcap_variable_field_label_changed_in_redcap_data_dictionary?(data_dictionary_variable['field_name'], data_dictionary_variable['field_label'])
            new_data_dictionary = true
          ...
          if redcap_project.redcap_variable_choices_changed_in_redcap_data_dictionary?(data_dictionary_variable['field_name'], data_dictionary_variable['select_choices_or_calculations'])
            new_data_dictionary = true
